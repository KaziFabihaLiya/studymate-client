        ...
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-gray-700 via-gray-900 to-black bg-clip-text text-transparent mb-4">
                Top Rated Partners
              </h2>
            ...
            {data && data.length > 0 ? (
              <>
                ...
                <div className="flex justify-center mt-12">
                  <button className="group relative px-8 py-4 bg-gradient-to-r from-gray-700 to-gray-900 text-white font-bold rounded-2xl shadow-2xl hover:shadow-gray-500/50 transition-all duration-500 hover:scale-105 overflow-hidden">
                    {/* Shimmer effect */}
